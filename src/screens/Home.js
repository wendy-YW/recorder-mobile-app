...
import { StyleSheet, View, Text, TouchableOpacity, Image, FlatList, ScrollView, ImageBackground } from "react-native";
                                    ...
                                    {filteredProjects.length > 0 ? (
                                        ...
                                        <View style={styles.emptyProjectContainer}>
                                            <View style={{ alignItems: 'flex-start' }}>
                                                <Text style={styles.emptyProjectText}>No record</Text>
                                                <Text style={styles.emptyProjectText}>Press + to Add</Text>
                                            </View>
                                        </View>
